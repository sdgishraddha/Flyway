package com.Shraddha.flightreservation.util;
...
public class EmailUtil {
	@Value("${com.Shraddha.flightreservation.itinerary.email.body}")
	private String EMAIL_BODY = "Please find your Itinerary attached.";

	@Value("${com.Shraddha.flightreservation.itinerary.email.subject}")
